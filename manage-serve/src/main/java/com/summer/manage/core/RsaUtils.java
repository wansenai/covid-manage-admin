...
public class RsaUtils {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(RsaUtils.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        test2(keyPair);
        System.out.println("\n");
        String text1 = encryptByPublicKey("MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAKQZHZUFmAhCxITzghcrtHivPXpujmS1cukvkQ4207vATCDslQezBI6It8vETzd78+9LpnO9AvoFKptJkmasag8CAwEAAQ==", SRC);
    ...
    public static String decryptByPrivateKey(String privateKeyText, String text) {
        ...
        try {
            ...
            LOG.error("the decryptByPrivateKey is error", e);
        }
